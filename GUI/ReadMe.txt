...
GUI.h
    ...
    GUIApplication application class.
...
MainDialog.h, MainDialog.cpp - the dialog
    These files contain your MainDialog class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in GUI.rc, which can be edited in Microsoft Visual C++.
